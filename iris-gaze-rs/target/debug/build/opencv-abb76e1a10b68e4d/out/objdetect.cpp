...
extern "C" {
	...
	void cv_QRCodeDetector_getEncoding_int(cv::QRCodeDetector* instance, int codeIdx, Result<cv::QRCodeEncoder::ECIEncodings>* ocvrs_return) {
		try {
			cv::QRCodeEncoder::ECIEncodings ret = instance->getEncoding(codeIdx);
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}

	void cv_QRCodeDetector_getEncoding(cv::QRCodeDetector* instance, Result<cv::QRCodeEncoder::ECIEncodings>* ocvrs_return) {
		try {
			cv::QRCodeEncoder::ECIEncodings ret = instance->getEncoding();
			Ok(ret, ocvrs_return);
		} OCVRS_CATCH(ocvrs_return);
	}
	...
	bool cv_aruco_CharucoParameters_propCheckMarkers_const(const cv::aruco::CharucoParameters* instance) {
			bool ret = instance->checkMarkers;
			return ret;
	}

	void cv_aruco_CharucoParameters_propCheckMarkers_const_bool(cv::aruco::CharucoParameters* instance, const bool val) {
			instance->checkMarkers = val;
	}
