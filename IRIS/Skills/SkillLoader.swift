...
class SkillLoader {
    ...
    func initialize() async {
        ...
        let fileSkills = FileSkillScanner.shared.scanAll()
        for fileSkill in fileSkills {
            registry.register(fileSkill.toIRISSkill())
        }
        print("📂 SkillLoader: Loaded \(fileSkills.count) file-based skills")
